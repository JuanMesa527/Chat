...
public class PlaneadorChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_planeador_chat);
    ...
    public void onSendMessage(View view) {
        ...
        Intent intent = new Intent(this, CiudadanoChatActivity.class);
